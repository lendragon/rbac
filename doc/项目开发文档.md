...
```typescript
{
    "id": Number,		// 要修改的用户id, 必填
    "addList": Array,	// 要添加的角色id列表
    "deleteList": Array	// 要删除的角色id列表
}
```
...
![image-20231220174811156](images/image-20231220174811156.png)
